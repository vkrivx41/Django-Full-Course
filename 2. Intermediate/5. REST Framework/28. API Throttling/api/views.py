...
from api.throttles import AnonProductsRateThrottle
from api.throttles import AnonOrdersRateThrottle
...
class ProductListCreateAPIView(generics.ListCreateAPIView):
    throttle_scope = 'user_products'
    throttle_classes = [AnonProductsRateThrottle, ScopedRateThrottle]
...
class OrderListApiView(generics.ListAPIView):
    ...
    throttle_classes = [AnonOrdersRateThrottle]
